...
void *kmalloc(u32int len)
{
	...
	header_t *cur_header = head_first;
	...
	else
	{
		...
		head_first = (header_t *)chunk_start;
	}
...
void test_heap()
{
	...
	printk("kmalloc 50000 byte in ox%X\n\n", addr4);
